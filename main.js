...
Webcam.set({
    ...
    classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/72Ku8VQqA/model.json',modelLoaded);
    ...
    function speak() {
        ...
        var utterThis = new SynthesisUtterance(speak_data_1);
